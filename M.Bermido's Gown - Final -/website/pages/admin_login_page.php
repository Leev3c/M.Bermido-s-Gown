    ...
    <nav class="navbar navbar-expand-lg bg-light fixed-top navbar-transparent " color-on-scroll="50">
        <div class="container">
            <div class="navbar-translate">
                <a href="../index.php" class="navbar-brand" rel="tooltip" title="Designed and Coded by Serve(8) Web Solutions, Inc." data-placement="bottom" style="color: #000000">
                    M.Bermido's Gown
                </a>
            ...
            <div class="col-md-4 content-center">
                <div class="card card-login card-plain">
                    <form class="form" method="POST" action="admin_login.php">
                        <div class="header header-primary text-center" style="color: #000000">
                            Administrator Login
                        </div><br>
                        <div class="card mt-5 bg-dark btn-round">
                            ...
                            <button type="submit" class="bbtn btn-light btn-round btn-lg btn-block" name="submit">Login</button>
                        </div>
