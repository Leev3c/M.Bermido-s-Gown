        ...
        <div class="page-header clear-filter" filter-color="white">
                ...
                <div class="container">
                    <div class="content-center brand">
                        <img src="../assets/img/bg.png" style="margin-top:15%; width: 600px; height: 600px">
                         <h2 style="color:#000000">High Quality and Affordable Gowns for Rent!.</h2>
                        <br><br>
                    ...
                    ?>   
                        <div class="row-sm-3">
                            <div class="thumbnail">
                                ...
                                <img src="../uploads/<?php echo $res['prod_pic1']; ?>" width="300px" height="350px">
                                <?php else: ?>
                                <img src="../uploads/default.png" width="300px" height="350px">
                                <?php endif; ?>
                            <div class="caption">
                              <h5><b><?php echo $res['prod_name'];?></b></h5>
                              <h6><a class="btn btn-dark btn-round" title="Click for more details!" href="user_product_details.php?prod_id=<?php echo $res['prod_id'];?>"><i class="now-ui-icons gestures_tap-01"></i>View</a><medium class="pull-right">Php<?php echo $res['prod_price']; ?></medium></h6>
                            </div>
