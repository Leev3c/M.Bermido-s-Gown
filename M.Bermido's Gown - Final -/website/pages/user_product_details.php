...
<div class="main">
    ...
    <div class="section" id="carousel">
        <div class="container">
            ...
            <a class="btn btn-dark btn-round" href="user_index.php"><i class="now-ui-icons arrows-1_minimal-left"></i> &nbsp Back to index</a>
            <hr color="black">
            <div class="col-md-12">
...
?>
        <?php }?> 
            ...
            <button class="btn btn-dark btn-round pull-right" data-toggle="modal" data-target="#myModal">
