...
?>
        ...
        <hr color="black"> 
        <br><br>
        <h3>Payment type will be a <b>Cash Upon Pick-up</b></h3>
        <h3>Pick-up process time, minimum of three(3) days and maximum of five(5) working days.</h3><br>
        <h5>M.Bemrido's Gown</h5>
        
     <button type="button" class="btn btn-info btn-round" onclick = "window.print()"><span class="now-ui-icons ui-1_check"></span> Print</button> 
     <a href="user_index.php"><button type="button" class="btn btn-dark btn-round"><span class="now-ui-icons ui-1_check"></span> Back to Homepage</button></a>
